...
function Config() {
	try {
		...
		// If Sync is to be run on a separate thread, use persistent storage only
		_config.cache = (typeof _config.forkSync === 'undefined' || !_config.forkSync) ? _config.cache: false;
